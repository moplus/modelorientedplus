...
namespace MoPlus.Interpreter.BLL.Entities
{
	...
	/// <summary></summary>
	///
	/// This file is for adding customizations to the EntityReference class
	...
	public partial class EntityReference : Solutions.PropertyBase
	{
		...
		public bool IsBaseProperty
		{
			get
			{
				return IsPropertyFound(EntityReferenceName, Entity, Solution, false);
			}
		}
		...
		#region "Methods"
		///--------------------------------------------------------------------------------
		/// <summary>This method determined if a reference entity property is
		...
		public static bool IsPropertyFound(string inputPropertyName, Entity inputEntity, Solution inputSolution, bool checkInputEntity)
		{
			...
			{
				// look for entity reference in base entity
			...
			{
				// look for entity reference in current entity
				foreach (EntityReference loopProperty in inputEntity.EntityReferenceList)
				{
					if (loopProperty.EntityReferenceName == inputPropertyName)
					{
						return true;
					}
				}
