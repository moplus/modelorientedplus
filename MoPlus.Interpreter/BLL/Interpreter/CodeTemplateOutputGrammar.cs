...
{
	///--------------------------------------------------------------------------------
	/// <summary>This class defines the grammar for the code template output.</summary>
	///
	/// <CreatedByUserName>DAVE\JavaDave</CreatedByUserName>
	/// <CreatedDate>9/8/2011</CreatedDate>
	/// <Status>Customized</Status>
	///--------------------------------------------------------------------------------
	public partial class CodeTemplateOutputGrammar : Grammar
	{
		...
		///--------------------------------------------------------------------------------
		public CodeTemplateOutputGrammar(Solution solution)
		{
			bool isFirstItem = true;
			this.LanguageFlags |= LanguageFlags.CreateAst;
			this.GrammarComments = "This grammar is used to parse the OUTPUT section of an M+ code template.";
			...
			this.Delimiters = "{}[](),:;+-*/%&|^!~<>=";
			this.MarkPunctuation("=", ";", ",", "(", ")", "{", "}", ".", LanguageTerms.ProgressTerm, LanguageTerms.TraceTerm, LanguageTerms.DebugTerm, LanguageTerms.WhileTerm, LanguageTerms.VarTerm, LanguageTerms.ParamTerm, LanguageTerms.IfTerm, LanguageTerms.ElseTerm, LanguageTerms.WithTerm, LanguageTerms.ForeachTerm, LanguageTerms.BreakTerm, LanguageTerms.ContinueTerm, LanguageTerms.ClearTerm, LanguageTerms.ReturnTerm, LanguageTerms.SwitchTerm, LanguageTerms.CaseTerm, LanguageTerms.DefaultTerm, LanguageTerms.WhereTerm, LanguageTerms.InTerm, LanguageTerms.LimitTerm, LanguageTerms.SortTerm, LanguageTerms.FromTerm, LanguageTerms.UpdateTerm, LanguageTerms.DeleteTerm, LanguageTerms.RemoveTerm, LanguageTerms.InsertTerm, LanguageTerms.ForfilesTerm, LanguageTerms.LogTerm, LanguageTerms.TextOpenTag, LanguageTerms.EvalOpenTag, LanguageTerms.OutputOpenTag, LanguageTerms.PropOpenTag, LanguageTerms.CloseTag);
			...
			var clearStatement = new NonTerminal("clearStatement", typeof(ClearPathStatementNode));
			...
			var updateStatement = new NonTerminal("updateStatement", typeof(UpdateStatementNode));
			var deleteStatement = new NonTerminal("deleteStatement", typeof(DeleteStatementNode));
			var removeStatement = new NonTerminal("removeStatement", typeof(RemoveStatementNode));
			var insertStatement = new NonTerminal("insertStatement", typeof(InsertStatementNode));
			var forfilesStatement = new NonTerminal("forfilesStatement", typeof(ForfilesStatementNode));
			...
			var outputProperty = new NonTerminal("outputProperty", typeof(OutputPropertyNode));
			#endregion
			...
			templatePropertyAssignmentStatement.Rule = ToTerm(LanguageTerms.PathProperty) + "=" + parameter;
			...
			// update statement
			updateStatement.Rule = ToTerm(LanguageTerms.UpdateTerm) + Lpar + parameter + Rpar
									| ToTerm(LanguageTerms.UpdateTerm) + Lpar + parameter + comma + parameter + Rpar;

			// delete statement
			deleteStatement.Rule = ToTerm(LanguageTerms.DeleteTerm) + Lpar + parameter + Rpar;

			// remove statement
			removeStatement.Rule = ToTerm(LanguageTerms.RemoveTerm) + Lpar + parameter+ comma + parameter + Rpar
									| ToTerm(LanguageTerms.RemoveTerm) + Lpar + parameter + comma + parameter + comma + parameter + comma + parameter + Rpar;

			// insert statement
			insertStatement.Rule = ToTerm(LanguageTerms.InsertTerm) + Lpar + parameter + comma + parameter + comma + parameter + Rpar
									| ToTerm(LanguageTerms.InsertTerm) + Lpar + parameter + comma + parameter + comma + parameter + comma + parameter + comma + parameter + Rpar;

			// forfiles statement
			forfilesStatement.Rule = ToTerm(LanguageTerms.ForfilesTerm) + Lpar + parameter + comma + StringLiteral + Rpar + Lbr + statementList + Rbr;
			...
			property.Rule = contentProperty | outputProperty | templateText;
			...
			// an output property contains a template property
			outputProperty.Rule = outputOpen + templateProperty + close;
			...
			modelProperty.Rule = assignableProperty
									...
									| ToTerm(LanguageTerms.ItemFileProperty)
									| ToTerm(LanguageTerms.ItemPathProperty)
