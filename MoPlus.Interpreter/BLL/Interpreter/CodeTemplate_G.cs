...
namespace MoPlus.Interpreter.BLL.Interpreter
{
	...
	/// specific CodeTemplate instances.</summary>
	///
	...
	///--------------------------------------------------------------------------------
	[Serializable()]
	[XmlRoot(Namespace="", ElementName="CodeTemplate")]
	[DataContract]
	[GeneratedCode("Intelligent Coding Solutions, LLC. Mo+ Solution Builder", "1.0")]
	public partial class CodeTemplate : Interpreter.Template
	{
		#region "Validation"
		///--------------------------------------------------------------------------------
		...
		private CodeTemplate _forwardInstance = null;
		///--------------------------------------------------------------------------------
		/// <summary>This property gets the forward engineering instance.</summary>
		///--------------------------------------------------------------------------------
		[XmlIgnore]
		public new CodeTemplate ForwardInstance
		{
			get
			{
		...
		private CodeTemplate _reverseInstance = null;
		///--------------------------------------------------------------------------------
		/// <summary>This property gets the reverse engineering instance.</summary>
		///--------------------------------------------------------------------------------
		[XmlIgnore]
		public new CodeTemplate ReverseInstance
		{
			get
			{
		...
		public override string DefaultSourceName
		{
			get
			{
				...
				{
					_defaultSourceName = DefaultSourcePrefix + SourceCodeTemplate.TemplateName;
				}
		...
		///--------------------------------------------------------------------------------
		[XmlIgnore]
		public CodeTemplate SourceCodeTemplate
		{
			get
			{
		...
		protected string _specificationDirectory = null;
		///--------------------------------------------------------------------------------
		...
		[DataElement]
		[DefaultValue(null)]
		public virtual string SpecificationDirectory
		{
			get
			{
				return _specificationDirectory;
			}
			set
			{
				if (_specificationDirectory != value)
				{
					_specificationDirectory = value;
					_isModified = true;
					base.OnPropertyChanged("SpecificationDirectory");
				}
			}
		}
		...
		{
			if (SpecificationDirectory.GetString() != inputCodeTemplate.SpecificationDirectory.GetString()) return false;
		...
		{
			if (inputCodeTemplate == null) return true;
			if (inputCodeTemplate.TagList.Count > 0) return false;
			if (!String.IsNullOrEmpty(inputCodeTemplate.SpecificationDirectory)) return false;
		...
		public static IDomainEnterpriseObject GetModelContext(Solution solutionContext, IDomainEnterpriseObject parentModelContext, out bool isValidContext)
		{
			...
			{
				if (modelContext is CodeTemplate)
				{
					return modelContext;
				}
				else if (solutionContext.IsSampleMode == true && solutionContext.NeedsSample == true && modelContext is Solution)
				{
					...
					if (parent.CodeTemplateList.Count > 0)
					{
						return parent.CodeTemplateList[DataHelper.GetRandomInt(0, parent.CodeTemplateList.Count - 1)];
					}
				}
				#region protected
				#endregion protected
			...
			if (solutionContext.IsSampleMode == true && solutionContext.NeedsSample == true && solutionContext.CodeTemplateList.Count > 0)
			{
				solutionContext.NeedsSample = false;
				return solutionContext.CodeTemplateList[DataHelper.GetRandomInt(0, solutionContext.CodeTemplateList.Count - 1)];
			}
		...
		public static IEnterpriseEnumerable GetCollectionContext(Solution solutionContext, IDomainEnterpriseObject modelContext)
		{
			...
			while (nodeContext != null)
			{
				...
				{
					return (nodeContext as Solution).CodeTemplateList;
				}
		...
		///--------------------------------------------------------------------------------
		/// <summary>This method gets the CodeTemplate instance from an xml file.</summary>
		///
		...
		///--------------------------------------------------------------------------------
		/// <summary>This method saves the CodeTemplate instance to an xml file.</summary>
		///
		...
		///--------------------------------------------------------------------------------
		/// <summary>This constructor creates a business logic CodeTemplate instance
		/// with primary key values.</summary>
		///
		/// <param name="primaryKeyValues">The primary key values to initialize the instance with.</param>
		///--------------------------------------------------------------------------------
		public CodeTemplate(string primaryKeyValues)
		{
		...
		///--------------------------------------------------------------------------------
		public CodeTemplate(Guid templateID)
		{
