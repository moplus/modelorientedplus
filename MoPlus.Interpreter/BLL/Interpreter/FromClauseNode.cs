...
{
	///--------------------------------------------------------------------------------
	/// <summary>This class implements necessary members for interpretation of from clauses.</summary>
	///
	/// <CreatedByUserName>DAVE\JavaDave</CreatedByUserName>
	/// <CreatedDate>9/29/2011</CreatedDate>
	/// <Status>Customized</Status>
	///--------------------------------------------------------------------------------
	public class FromClauseNode : NonLeafGrammarNode
	{
		///--------------------------------------------------------------------------------
		...
		public override string DisplayName
		{
			get
			{
				return LineNumber.ToString() + ": " + DisplayValues.TemplateNode_FromClause;
			}
		}

		public ContextHelperNode ContextHelper { get; set; }
		...
		public override void Init(ParsingContext context, ParseTreeNode treeNode)
		{
			try
			{
				...
				{
					if (node.AstNode is ContextHelperNode)
					{
						ContextHelper = node.AstNode as ContextHelperNode;
						ChildNodes.Add(node.AstNode as ContextHelperNode);
					}
				}
			}
