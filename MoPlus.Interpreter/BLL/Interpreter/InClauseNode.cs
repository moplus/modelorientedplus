...
namespace MoPlus.Interpreter.BLL.Interpreter
{
	...
	///--------------------------------------------------------------------------------
	public class InClauseNode : NonLeafGrammarNode
	{
		///--------------------------------------------------------------------------------
		...
		public InClauselItemNode InClauselItem { get; set; }
		...
		public override void Init(ParsingContext context, ParseTreeNode treeNode)
		{
			try
			{
				...
				{
					if (node.AstNode is InClauselItemNode)
					{
						InClauselItem = node.AstNode as InClauselItemNode;
						ChildNodes.Add(node.AstNode as InClauselItemNode);
					}
				}
			}
