...
namespace MoPlus.Interpreter.BLL.Interpreter
{
	...
	///--------------------------------------------------------------------------------
	public partial class SpecTemplate : Template, ITemplate
	{
		...
		public string SuggestedFilePath
		{
			get
			{
				if (!String.IsNullOrEmpty(SpecificationDirectory))
				{
					...
					{
						return SpecificationDirectory + "\\" + NodeName + "\\" + TemplateName + ".mps";
					}
					else
					{
		...
		///--------------------------------------------------------------------------------
		/// <summary>This method gets the best matching model context for this template.</summary>
		///--------------------------------------------------------------------------------
		public IDomainEnterpriseObject GetMostRelevantSampleContext()
		{
		...
		{
			return GenerateContentAndOutput(GetMostRelevantSampleContext());
		}
