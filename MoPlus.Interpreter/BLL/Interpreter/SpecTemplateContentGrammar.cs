...
{
	///--------------------------------------------------------------------------------
	/// <summary>This class defines the grammar for the specification template content.</summary>
	///
	/// <CreatedByUserName>DAVE\JavaDave</CreatedByUserName>
	/// <CreatedDate>11/13/2011</CreatedDate>
	/// <Status>Customized</Status>
	///--------------------------------------------------------------------------------
	public partial class SpecTemplateContentGrammar : Grammar
	{
		...
		///--------------------------------------------------------------------------------
		public SpecTemplateContentGrammar()
		{
			bool isFirstItem = true;
			this.LanguageFlags |= LanguageFlags.CreateAst;
			this.GrammarComments = "This grammar is used to parse the CONTENT section of an M+ spec template.";
			...
			currentItemAssignmentStatement.Rule = currentItem + "=" + modelContext
													| currentItem + "=" + "null"
