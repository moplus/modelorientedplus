...
//	CurrentEntity.DbSchema = Schema
	...
	// set entity type
	if (MDLTableName.StartsWith("tlkp") == true)
	{
		// lookup entity
		CurrentEntity.EntityTypeCode = 1 // Lookup
	}
	else if (MDLTableName.StartsWith("trel") == true || PrimaryAndForeignKeyColumnCount > 1)
	{
		// relational entity
		CurrentEntity.EntityTypeCode = 8 // Relational
	}
	else if (MDLTableName.StartsWith("tbl") == true && (MDLTableName.EndsWith("Log") == true || MDLTableName.EndsWith("History") == true))
	{
