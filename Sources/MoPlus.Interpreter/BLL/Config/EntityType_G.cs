...
namespace MoPlus.Interpreter.BLL.Config
{
	...
	/// specific EntityType instances.</summary>
	///
	...
	///--------------------------------------------------------------------------------
	[Serializable()]
	[XmlRoot(Namespace="", ElementName="EntityType")]
	[DataContract]
	[GeneratedCode("Intelligent Coding Solutions, LLC. Mo+ Solution Builder", "1.0")]
	public partial class EntityType : BusinessObjectBase
	{
		#region "Validation"
		///--------------------------------------------------------------------------------
		...
		public virtual string GetValidationErrors()
		{
			...
			error = GetValidationError("EntityTypeName");
		...
		public override string GetValidationError(string fieldName)
		{
			...
			switch (fieldName)
			{
				case "_entityTypeName":
				case "EntityTypeName":
					error = ValidateEntityTypeName();
					break;
				case "_description":
				case "Description":
		...
		///--------------------------------------------------------------------------------
		/// <summary>This method validates EntityTypeName and returns an error message if not valid.</param>
		///--------------------------------------------------------------------------------
		public string ValidateEntityTypeName()
		{
			if (!Regex.IsMatch(EntityTypeName, Resources.DisplayValues.Regex_Name))
			{
				return String.Format(Resources.DisplayValues.Validation_AlphanumericValue, "EntityTypeName");
			}
			return null;
		}
		...
		private EntityType _forwardInstance = null;
		///--------------------------------------------------------------------------------
		/// <summary>This property gets the forward engineering instance.</summary>
		///--------------------------------------------------------------------------------
		[XmlIgnore]
		public EntityType ForwardInstance
		{
			get
			{
		...
		private EntityType _reverseInstance = null;
		///--------------------------------------------------------------------------------
		/// <summary>This property gets the reverse engineering instance.</summary>
		///--------------------------------------------------------------------------------
		[XmlIgnore]
		public new EntityType ReverseInstance
		{
			get
			{
		...
		public string OriginalName
		{
			get
			{
				return SourceEntityType.EntityTypeName;
			}
		}
		...
		public string DisplayName
		{
			get
			{
				...
				{
					_displayName = EntityTypeName;
				}
				
				#region protected
				if (_displayName == EntityTypeName)
				{
					_displayName = EntityTypeName + " (" + EntityTypeCode.ToString() + ")";
				}
				#endregion protected
		...
		public virtual string DefaultSourceName
		{
			get
			{
				...
				{
					_defaultSourceName = DefaultSourcePrefix + SourceEntityType.EntityTypeName;
				}
		...
		///--------------------------------------------------------------------------------
		/// <summary>This property gets or sets the EntityTypeName.</summary>
		///--------------------------------------------------------------------------------
		[XmlElement()]
		[DataMember]
		[DataElement]
		...
		public virtual string EntityTypeName
		{
			...
			set
			{
				if (_entityTypeName != value)
				{
					...
					_isModified = true;
					base.OnPropertyChanged("EntityTypeName");
				}
			}
		}
		...
		public override string PrimaryKeyValues
		{
			get
			{
				return EntityTypeCode.GetString();
			}
			set
			{
				...
				{
					EntityTypeCode = primaryKeyValues[0].GetInt();
				}
			}
		}
		...
		public override void AddTag(string tagName)
		{
			if (ReverseInstance == null)
			{
				ReverseInstance = new EntityType();
				ReverseInstance.TransformDataFromObject(this, null, false);
			}
			base.AddTag(tagName);
			if (ForwardInstance == null)
			{
				ForwardInstance = new EntityType();
				ForwardInstance.EntityTypeCode = EntityTypeCode;
			}
		...
		{
			if (EntityTypeName.GetString() != inputEntityType.EntityTypeName.GetString()) return false;
			if (Description.GetString() != inputEntityType.Description.GetString()) return false;
		...
		/// <param name="inputEntityType">The entitytype to compare metadata.</param>
		///--------------------------------------------------------------------------------
		public bool IsEmptyMetadata(EntityType inputEntityType)
		{
			if (inputEntityType == null) return true;
			if (inputEntityType.TagList.Count > 0) return false;
			if (!String.IsNullOrEmpty(inputEntityType.EntityTypeName)) return false;
			if (!String.IsNullOrEmpty(inputEntityType.Description)) return false;
		...
		///
		/// <param name="inputEntityType">The entitytype to get metadata.</param>
		///--------------------------------------------------------------------------------
		public void CopyChangedMetadata(EntityType inputEntityType)
		{
			EntityTypeName = inputEntityType.EntityTypeName;
			Description = inputEntityType.Description;
		...
		///--------------------------------------------------------------------------------
		public EntityType GetForwardInstance(Solution forwardSolution)
		{
			bool isCustomized = false;
			EntityType forwardItem = new EntityType();
			if (ForwardInstance != null)
			{
		...
		///--------------------------------------------------------------------------------
		/// <summary>This method gets the EntityType instance from an xml file.</summary>
		///
		...
		///--------------------------------------------------------------------------------
		/// <summary>This method saves the EntityType instance to an xml file.</summary>
		///
		...
		///--------------------------------------------------------------------------------
		/// <summary>This constructor creates a business logic EntityType instance
		/// with primary key values.</summary>
		///
		/// <param name="primaryKeyValues">The primary key values to initialize the instance with.</param>
		///--------------------------------------------------------------------------------
		public EntityType(string primaryKeyValues)
		{
		...
		///
		/// <param name="entityTypeCode">The input value for EntityTypeCode.</param>
		///--------------------------------------------------------------------------------
		public EntityType(int entityTypeCode)
		{
