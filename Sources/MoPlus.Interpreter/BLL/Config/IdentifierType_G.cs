...
namespace MoPlus.Interpreter.BLL.Config
{
	...
	/// specific IdentifierType instances.</summary>
	///
	...
	///--------------------------------------------------------------------------------
	[Serializable()]
	[XmlRoot(Namespace="", ElementName="IdentifierType")]
	[DataContract]
	[GeneratedCode("Intelligent Coding Solutions, LLC. Mo+ Solution Builder", "1.0")]
	public partial class IdentifierType : BusinessObjectBase
	{
		#region "Validation"
		///--------------------------------------------------------------------------------
		...
		public virtual string GetValidationErrors()
		{
			...
			error = GetValidationError("IdentifierTypeName");
		...
		public override string GetValidationError(string fieldName)
		{
			...
			switch (fieldName)
			{
				case "_identifierTypeName":
				case "IdentifierTypeName":
					error = ValidateIdentifierTypeName();
					break;
				case "_description":
				case "Description":
		...
		///--------------------------------------------------------------------------------
		/// <summary>This method validates IdentifierTypeName and returns an error message if not valid.</param>
		///--------------------------------------------------------------------------------
		public string ValidateIdentifierTypeName()
		{
			if (!Regex.IsMatch(IdentifierTypeName, Resources.DisplayValues.Regex_Name))
			{
				return String.Format(Resources.DisplayValues.Validation_AlphanumericValue, "IdentifierTypeName");
			}
			return null;
		}
		...
		private IdentifierType _forwardInstance = null;
		///--------------------------------------------------------------------------------
		/// <summary>This property gets the forward engineering instance.</summary>
		///--------------------------------------------------------------------------------
		[XmlIgnore]
		public IdentifierType ForwardInstance
		{
			get
			{
		...
		private IdentifierType _reverseInstance = null;
		///--------------------------------------------------------------------------------
		/// <summary>This property gets the reverse engineering instance.</summary>
		///--------------------------------------------------------------------------------
		[XmlIgnore]
		public new IdentifierType ReverseInstance
		{
			get
			{
		...
		public string OriginalName
		{
			get
			{
				return SourceIdentifierType.IdentifierTypeName;
			}
		}
		...
		public string DisplayName
		{
			get
			{
				...
				{
					_displayName = IdentifierTypeName;
				}
				
				#region protected
				if (_displayName == IdentifierTypeName)
				{
					_displayName = IdentifierTypeName + " (" + IdentifierTypeCode.ToString() + ")";
				}
				#endregion protected
		...
		public virtual string DefaultSourceName
		{
			get
			{
				...
				{
					_defaultSourceName = DefaultSourcePrefix + SourceIdentifierType.IdentifierTypeName;
				}
		...
		///--------------------------------------------------------------------------------
		[XmlIgnore]
		public IdentifierType SourceIdentifierType
		{
			get
			{
		...
		///--------------------------------------------------------------------------------
		/// <summary>This property gets or sets the IdentifierTypeName.</summary>
		///--------------------------------------------------------------------------------
		[XmlElement()]
		[DataMember]
		[DataElement]
		...
		public virtual string IdentifierTypeName
		{
			...
			set
			{
				if (_identifierTypeName != value)
				{
					_identifierTypeName = value;
					_isModified = true;
					base.OnPropertyChanged("IdentifierTypeName");
				}
			}
		}
		...
		public override string PrimaryKeyValues
		{
			get
			{
				return IdentifierTypeCode.GetString();
			}
			set
			{
				...
				{
					IdentifierTypeCode = primaryKeyValues[0].GetInt();
				}
			}
		}
		...
		{
			if (IdentifierTypeName.GetString() != inputIdentifierType.IdentifierTypeName.GetString()) return false;
			if (Description.GetString() != inputIdentifierType.Description.GetString()) return false;
		...
		{
			if (inputIdentifierType == null) return true;
			if (inputIdentifierType.TagList.Count > 0) return false;
			if (!String.IsNullOrEmpty(inputIdentifierType.IdentifierTypeName)) return false;
			if (!String.IsNullOrEmpty(inputIdentifierType.Description)) return false;
		...
		///--------------------------------------------------------------------------------
		/// <summary>This method gets the IdentifierType instance from an xml file.</summary>
		///
		...
		///--------------------------------------------------------------------------------
		/// <summary>This method saves the IdentifierType instance to an xml file.</summary>
		///
		...
		///--------------------------------------------------------------------------------
		/// <summary>This constructor creates a business logic IdentifierType instance
		/// with primary key values.</summary>
		///
		/// <param name="primaryKeyValues">The primary key values to initialize the instance with.</param>
		///--------------------------------------------------------------------------------
		public IdentifierType(string primaryKeyValues)
		{
		...
		///
		/// <param name="identifierTypeCode">The input value for IdentifierTypeCode.</param>
		///--------------------------------------------------------------------------------
		public IdentifierType(int identifierTypeCode)
		{
