...
namespace MoPlus.ViewModel.Entities
{
	...
	/// <summary></summary>
	///
	/// This file is for adding customizations to the ParameterViewModel view
	...
	public partial class ParameterViewModel : DialogEditWorkspaceViewModel
	{
		...
		public EnterpriseDataObjectList<Entity> ReferencedEntityIDItems
		{
			get
			{
				if (ReferencedEntityID == null || ReferencedEntityID == Guid.Empty)
				{
					ReferencedEntityID = Parameter.Method.EntityID;
				}
