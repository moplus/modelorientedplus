...
{
    ///--------------------------------------------------------------------------------
    /// <summary>This class provides the view for the spec template content and parse results.</summary>
    /// 
    ///--------------------------------------------------------------------------------
	public class SpecTemplateResultsViewModel : EditWorkspaceViewModel
	{
		#region "Properties"
		///--------------------------------------------------------------------------------
		...
		///--------------------------------------------------------------------------------
		public SpecTemplateResultsViewModel()
		{
		...
		///--------------------------------------------------------------------------------
		public SpecTemplateResultsViewModel(string templateName, InterpreterTypeCode templateType, TemplateNode ast, string sampleCode)
		{
			Name = templateName;
