...
namespace MoPlus.ViewModel.Interpreter
{
	...
	/// <summary></summary>
	///
	/// This file is for adding customizations to the SpecTemplateViewModel view
	...
	public partial class SpecTemplateViewModel : DialogEditWorkspaceViewModel
	{
		...
		public SortableObservableCollection<string> Nodes
		{
			get
			{
				return DataConventionHelper.SpecTemplateNodes;
			}
		}
		...
		public TextDocument TemplateContentDocument
		{
			get
			{
				if (_templateContentDocument == null)
				{
					...
					_templateContentDocument.Text = EditSpecTemplate.TemplateContent;
		...
		public TextDocument TemplateOutputDocument
		{
			get
			{
				if (_templateOutputDocument == null)
				{
					...
					_templateOutputDocument.Text = EditSpecTemplate.TemplateOutput;
		...
		public bool IsTemplateUtilized
		{
			get
			{
				return SpecTemplate.IsTemplateUtilized && SpecTemplate.HasErrors == false;
			}
		}
		...
		public string ToolTipText
		{
			get
			{
				return SpecTemplate.TemplateCallInfo;
			}
		}
		...
		public EnterpriseDataObjectList<DebugItem> ContentDebugItems
		{
			get
			{
				return SpecTemplate.ContentDebugItems;
			}
			set
			{
				SpecTemplate.ContentDebugItems = value;
			}
		}
		...
		public EnterpriseDataObjectList<DebugItem> OutputDebugItems
		{
			get
			{
				return SpecTemplate.OutputDebugItems;
			}
			set
			{
				SpecTemplate.OutputDebugItems = value;
			}
		}
		...
		{
			Solution = solution;
			SpecTemplate.Solution = solution;
		}
